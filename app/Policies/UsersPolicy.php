...
class UsersPolicy
{
    ...
    {
        return $user->can('delete_any_users');
    }
    ...
    {
        return $user->can('force_delete_any_users');
    }
    ...
    {
        return $user->can('restore_any_users');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Users $users): bool
    {
        return $user->can('replicate_users');
    }
